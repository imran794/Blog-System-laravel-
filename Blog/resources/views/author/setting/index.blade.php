                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="profile_with_icon_title">
                                <form method="POST" action="{{ route('author.update.profile') }}" class="form-horizontal" enctype="multipart/form-data">
                                  @csrf
                                  @method('PUT')
                                    <div class="row clearfix">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
                                <form method="POST" action="{{ route('author.change.password') }}" class="form-horizontal">
                                    @csrf
